<div id="khung">
    <div id="main">
        <div class="toolbar-list" id="toolbar">
            <ul>
                <li id="toolbar-new"> <a href="<?php echo DOMAINAD; ?>product/add" class="toolbar"> <span class="icon-32-new"></span> Thêm mới </a> </li>
                <li class="divider"></li>
            ...
            <table width="100%">
                    <thead>
                        <tr>
                            ...
                            <th width="30%" style="text-align:center;"><?php echo $this->Paginator->sort('Product.name', 'Tên sản phẩm'); ?></th>
                            <th width="15%"><?php echo $this->Paginator->sort('Product.product_category_id', 'Danh mục'); ?></th>
                            <th width="11%"><?php echo $this->Paginator->sort('Product.sort_order', 'Sắp xếp'); ?></th>
                            <th width="11%"><?php echo $this->Paginator->sort('Product.modified', 'Thay đổi'); ?></th>
                            <th width="12%">Xử lý</th>
                            <th width="3%"><?php echo $this->Paginator->sort('Product.id', 'Mã'); ?></th>
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                           		<img src="<?php echo DOMAINAD?>/timthumb.php?src=<?php echo $value['Product']['images'];?>&amp;h=100&amp;w=100&amp;zc=1" />
                            </td>
                            ...
                            <td><?php echo $value['Product']['sort_order']; ?></td>
                            <td>
                                <?php echo date('d-m-Y', strtotime($value['Product']['modified'])); ?></td>
                            <td>
