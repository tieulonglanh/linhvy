<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'video/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
<div id="khung">
    <div id="main">
                ...
                <tr>
					...
					<?php 
						echo $this->Form->radio(
								...
								array('legend'=>false, 'style'=>'float: left; cursor: pointer; margin-left: 20px;', 'class'=>'choose_type_video')		
						);
					?>
                    </td>
                </tr>
