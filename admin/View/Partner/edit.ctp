<?php echo $this->Form->create(null, array('url' => DOMAINAD .'partner/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
<div id="khung">
    <div id="main">
            ...
            <table width="100%" class="input">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo $this->Form->input('Partner.id',array('type'=>'hidden'));?>
