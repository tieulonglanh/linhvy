<div id="khung">
    <div id="main">
        <div class="toolbar-list" id="toolbar">
            <ul>
                <li id="toolbar-new"> <a href="<?php echo DOMAINAD; ?>gallery_category/add" class="toolbar"> <span class="icon-32-new"></span> Thêm mới </a> </li>
                <li class="divider"></li>
        ...
        <div class="pagetitle icon-48-nhomtin">
            <h2>Danh sách danh mục Album ảnh</h2>
        </div>
        <div class="clr"></div>
    </div>
</div>
