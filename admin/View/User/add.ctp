<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'User/add', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
<div id="khung">
    <div id="main">
                ...
                <tr>
					...
					<?php 
						echo $this->Form->radio(
								...
								array('legend'=>false, 'style'=>'float: left; cursor: pointer;', 'value'=>1)		
						);
					?>
                    </td>
                </tr>
