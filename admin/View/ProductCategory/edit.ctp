    ...
    <div id="main">
        <div class="toolbar-list" id="toolbar">
            <ul>
                ...
                <li id="toolbar-unpublish"> <a href="<?php echo DOMAINAD; ?>product_category" class="toolbar"> <span class="icon-32-cancel"></span> Hủy </a> </li>
            </ul>
            <div class="clr"></div>
        </div>
    ...
    <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
            <table width="100%" class="input">
                ...
                <tr>
                    <td class="label" width="120">Tên danh mục Sản phẩm</td>
                    <td><?php echo $this->Form->input('ProductCategory.name', array('label' => '', 'class' => 'text-input medium-input', 'onchange' => 'get_alias()', 'id' => 'idtitle')); ?>
                    </td>
               	</tr>
                
                <tr>
                    <td class="label" width="120">Tên tiếng anh</td>
                    <td><?php echo $this->Form->input('ProductCategory.name_en', array('label' => '', 'class' => 'text-input medium-input')); ?></td>
               	</tr>
                
                <tr>
                    <td class="label" width="120">Đường dẫn ảo</td>
                    <td><?php echo $this->Form->input('ProductCategory.alias', array('label' => '', 'class' => 'text-input medium-input', 'id' => 'idalias')); ?></td>
               	</tr>
                
                <tr>
                    <td class="label" width="120">Danh mục cha</td>
                    <td>
						<?php echo $this->Form->input('ProductCategory.parent_id',array('type'=>'select','options'=>$list_cat,'empty'=>'Chọn danh mục','class'=>'small-input','label'=>''));?>
					</td>
               	</tr>

                <tr>
                    <td class="label" width="120">Sắp xếp</td>
                    <td><?php echo $this->Form->input('ProductCategory.sort_order', array('label' => '', 'class' => 'text-input medium-input')); ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo $this->Form->input('ProductCategory.images',array('label'=>false, 'class'=>'text-input image-input datepicker','id' => 'xFilePath','maxlength'=>'255', 'style'=>'margin-left: 20px;'));?>
