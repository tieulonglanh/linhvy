<?php echo $this->Form->create(null, array('url' => DOMAINAD . 'video_category/edit', 'type' => 'post', 'enctype' => 'multipart/form-data', 'name' => 'image')); ?>
<div id="khung">
    <div id="main">
            ...
            <table width="100%" class="input">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo $this->Form->input('VideoCategory.id',array('type'=>'hidden'));?>
